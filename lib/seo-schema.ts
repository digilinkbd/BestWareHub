 ...
 * This utility function can be used in other parts of your application
...
/**
 * Generate organization schema for a store/vendor
 */
export function generateOrganizationSchema(product: any) {
