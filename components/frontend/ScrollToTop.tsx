      ...
      {isVisible && (
        ...
        >
          <div className="relative">
            ...
            <Button
              onClick={scrollToTop}
              className="relative rounded-full p-3 lg:p-5 bg-gradient-to-br from-amber-400 to-amber-500 hover:from-amber-500 hover:to-amber-600 shadow-lg border-2 border-amber-300 text-white"
              size="icon"
            >
              <motion.div
            ...
            />
            <motion.div
              className="absolute -bottom-1 -left-1 w-4 h-4 rounded-full bg-amber-300"
              animate={{
                x: [0, -8, 0],
                y: [0, 8, 0],
                opacity: [0.7, 0.3, 0.7]
