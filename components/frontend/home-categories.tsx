...
export interface HomeDepartmentsProps {
...
export default function HomeCategories({ 
  ...
  const totalIndicators = Math.ceil(departments.length / (isMobile ? 8 : 8))
      ...
      >
        {isLoading ? (
          ...
          departments.map((dept) => (
            <Link href={`${linkPrefix}${dept.slug}`} key={dept.id} className="snap-start flex flex-col items-center gap-2 cursor-pointer group">
