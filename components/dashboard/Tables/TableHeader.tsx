...
import type { Options, SelectValue } from "react-tailwindcss-select/dist/components/type"
import {
  Dialog,
  DialogClose,
  DialogContent,
...
export default function TableHeader({ title, href, linkTitle, data, model, showImport = true }: TableHeaderProps) {
  ...
  return (
    ...
    >
      <motion.div
        className="flex justify-between items-center border-b border-gray-200 dark:border-gray-600 py-3"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        >
                    ...
                    {uploadSuccess ? (
                      <DialogContent className="sm:max-w-[425px]">
                        <DialogHeader>
                          <DialogTitle>Excel Upload</DialogTitle>
                          <DialogDescription className="text-xs">
                            You can Bring all your Data from excel, Please Download the Sample file First to Make Sure
                            you have Data Columns Required
                          </DialogDescription>
                        </DialogHeader>
                        <motion.div
                          className="h-72 w-full rounded-md border flex items-center justify-center flex-col"
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                        ...
                        >
                          ...
                          <motion.h2
                            className="text-xs pt-2 px-8 text-center"
                            initial={{ opacity: 0 }}
                            animate={{ opacity: 1 }}
                      ...
                      <DialogContent className="sm:max-w-[425px]">
                        ...
                        {preview && jsonData ? (
                          ...
                          <div className="grid gap-4 py-4">
                            ...
                            {excelFile && (
                              <motion.div
                                className="flex items-center shadow-lg rounded-md lg:py-3 py-2 px-6 bg-slate-100 dark:bg-slate-800 justify-between"
          ...
          <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            <Button size="sm" asChild className="h-8 gap-1 bg-yellow-600">
              <Link href={href}>
